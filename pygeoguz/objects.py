...
class Ellipsoid:
    def __init__(self, equatorial_radius, flattering):
        ...
        self._polar_radius = -self._equatorial_radius / self._flattering + self._equatorial_radius
    ...
    def eccentricity(self):
        e = math.sqrt(self._equatorial_radius**2 - self._polar_radius**2) / self._equatorial_radius
        return e

    def second_eccentricity(self):
        e = math.sqrt(self._equatorial_radius ** 2 - self._polar_radius ** 2) / self._polar_radius
        return e

    def square(self):
        a = self._equatorial_radius
        b = self._polar_radius
        s = 2 * math.pi * a * (a + b**2 / math.sqrt(a**2 - b**2) * math.log((a + math.sqrt(a**2 - b**2)) / b))
        return s
    ...
    def calculate_ellipsoid(self):
        return {'equatorial_radius': self._equatorial_radius,
