...
def pz2wgs(point: Point3D) -> Point3D:
    ...
    """
    koeff_m = 1 - 0.12e-6
    rotation = np.array([[1, -0.9696e-6, 0], [0.9696e-6, 1, 0], [0, 0, 1]])
...
def bl2xy(point: PointBL) -> Point2D:
    ...
    :return: Точка в плоской прямоугольной СК Гаусса-Крюгера
    """
...
def xy2bl(point: Point2D) -> PointBL:
    ...
    :param point: очка в плоской прямоугольной СК Гаусса-Крюгера
    ...
    b_0 = betta + sin(2 * betta) * (
        0.00252588685
        - 0.00001491860 * sin(betta) ** 2
        + 0.00000011904 * sin(betta) ** 4
    )
    ...
    delta_b = (
        ...
        * (
            0.251684631
            - 0.003369263 * sin(b_0) ** 2
            + 0.000011276 * sin(b_0) ** 4
            - (z_0) ** 2
            * (
                0.10500614
                - 0.04559916 * sin(b_0) ** 2
                + 0.00228901 * sin(b_0) ** 4
                - 0.00002987 * sin(b_0) ** 6
                - (z_0) ** 2
                * (
                    0.042858
                    - 0.025318 * sin(b_0) ** 2
    ...
    l = z_0 * (
        1
        - 0.0033467108 * sin(b_0) ** 2
        - 0.0000056002 * sin(b_0) ** 4
        - 0.0000000187 * sin(b_0) ** 6
        - (z_0) ** 2
        * (
            0.16778975
            + 0.16273586 * sin(b_0) ** 2
            - 0.00052490 * sin(b_0) ** 4
            - 0.00000846 * sin(b_0) ** 6
            - (z_0) ** 2
            * (
                0.0420025
                + 0.1487407 * sin(b_0) ** 2
