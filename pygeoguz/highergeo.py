...
def pgz_spherical(latitude, longitude, line_spherical: LineBL):
    ...
    sin_phi_2 = math.sin(phi_1) * math.cos(sigma) + math.cos(phi_1) * math.sin(sigma) * math.cos(alpha_1)

    alpha_2 = math.atan2((math.cos(phi_1) * math.cos(alpha_1)),
                         (math.cos(phi_1) * math.cos(sigma) * math.cos(alpha_1) - math.sin(phi_1) * math.sin(sigma)))

    delta_lambda = math.atan2(math.sin(sigma) * math.sin(alpha_1),
                              math.cos(phi_1) * math.cos(sigma) - sin_phi_2 * math.sin(sigma) * math.sin(alpha_1))
    ...
    return PointBL(true_phi_2, true_lambda_2), LineBL(line_spherical.length, true_alpha_2)